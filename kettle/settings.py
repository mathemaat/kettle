"""
Django settings for kettle project.
...
SECRET_KEY = 'f$6a^pw)sholx3707u)+^)82e^#2bux&_(hzmz_)^doylkns*1'
...
WSGI_APPLICATION = 'kettle.wsgi.application'
